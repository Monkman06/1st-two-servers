...
function display_portfolio(url, req, res) {
  ...
  myHTML += '</body></html>';
  res.writeHead(200, {'Content-Type': 'text/html'});// tells brower its going to send html
...
function display_404(url, req, res) {
  ...
  res.end("The page you were looking for: " + url + " can not be found ");// sends 404 ahead so browser know search item cant be found
}